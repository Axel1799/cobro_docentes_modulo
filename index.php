			...
			<div class="wrap-contact2">
				<form action="/cobro/search.php" method="POST" class="contact2-form validate-form">
					...
					<div class="form-outline">
						<input STYLE="text-transform:uppercase" width="30px" type="search" id="acta" name="acta" class="form-control" required />
						<p style="color: red">No ingresar espacios o caracteres especiales</p>
					</div>
